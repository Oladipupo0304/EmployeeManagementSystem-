...
namespace EMSAPP.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Dep_Name")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Dep_Name")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
